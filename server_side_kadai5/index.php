    ...
    <form method="post" action="confirm.php" enctype="multipart/form-data">
        <div class="mb-3">
            <fieldset class='field'>
                <legend>書籍記録</legend>
                <label>書籍名：<input type="text" name="name" class="title"></label><br>
                <label>書籍URL:<input type="text" name="url" class="url"></label><br>
                <label>書籍コメント:<br><textArea name="content" class="comment" rows="4" cols="40"></textArea></label><br>
              ...
              <p><input type="submit" class="submit" value="登録"></p>      
    </form>  
    <body class='p16'>
